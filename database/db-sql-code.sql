...
-- Create relationship between 'classifications and S inventory' tables
...
-- Create relationship between 'account and inventory' tables in the review table
ALTER TABLE IF EXISTS public.review
	ADD CONSTRAINT fk_review_acc FOREIGN KEY (account_id)
	REFERENCES public.account (account_id) MATCH SIMPLE
	ON UPDATE CASCADE
	ON DELETE NO ACTION;

ALTER TABLE IF EXISTS public.review
	ADD CONSTRAINT fk_review_inv FOREIGN KEY (inv_id)
